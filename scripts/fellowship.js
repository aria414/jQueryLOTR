...
const keepItSecretKeepItSafe = () => {
  ...
  // 2. add the ring as a child of Frodo
    ...
    const $hobbits = $(".hobbit") //select everything with the class hobbit. it returns an array
    $($hobbits[0]).append($div) //access the first element in the array
...
const leaveTheShire = () => {
  ...
  // hint: the hobbits ul is a childNode of The-Shire-- there is way to get a list of childNodes
    ...
    const $hobbits = $("#The-Shire > ul")
    //$hobbits.css("border", "2px solid red") //check if the right UL is selected
...
const beautifulStranger = () => {
  console.log("Meet Aragorn")
  // 1. change the buddy 'Strider' textnode to "Aragorn"
     // hint: You can get a list of elements by tag name, such as 'aside'
  const $strider = $("aside ul li:nth-child(4)")
...
// ============
const hornOfGondor = () => {
  console.log("Ch 10 Horn of Gondor")
  ...
  //the number of li with buddy class is less since we changed gandalf's class
  $(".buddy").eq(3).css("text-decoration", "line-through")

  // 3. Tricky: Remove the Uruk-Hai from the Baddies on the page
  const $uruk = $( "li:contains('Uruk')" )
  $uruk.remove()
};
